export type JobStatus = "waiting" | "active" | "completed" | "failed" | "delayed" | "paused" | "unknown";
...
export type CopySimulationMissedReason = "ACTION_FILTERED" | "CATEGORY_EXCLUDED" | "UNRESOLVED_MARKET_EXCLUDED" | "OVERSIZED_TRADE" | "LIQUIDITY_FILTERED" | "DRAWDOWN_STOP" | "BELOW_MIN_SIZE" | "MAX_POSITION_SIZE" | "MAX_MARKET_EXPOSURE" | "MAX_TOTAL_EXPOSURE" | "INSUFFICIENT_BALANCE" | "NOTHING_TO_REDUCE";
...
export interface WalletRankingDto {
    walletAddress: string;
    finalScore: number;
    classification: "Prime copy candidate" | "Strong copy candidate" | "Watchlist candidate" | "High-risk candidate" | "Avoid copying";
    components: {
